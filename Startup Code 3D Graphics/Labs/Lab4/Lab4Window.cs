...
namespace Labs.Lab4
{
    ...
    {
        public Lab4Window()
            : base(800, 600, GraphicsMode.Default, "Lab 4 Textures", GameWindowFlags.Default,
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            GL.ActiveTexture(TextureUnit.Texture0); GL.GenTextures(1, out textureID); GL.BindTexture(TextureTarget.Texture2D, textureID);
            ...
            GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureMinFilter, (int)TextureMinFilter.Linear); GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureMagFilter, (int)TextureMagFilter.Linear);
